...
function Tree(){
    var url = request_uri.setQuery('mid',current_mid).setQuery('act','getXedocsTreeList');
    ...
    jQuery.get(url,function(data){
        ...
        simpleTreeCollection = jQuery('.simpleTree').simpleTree({
            ...
            afterMove:function(destination, source, pos){
                ...
                jQuery.exec_json("xedocs.procXedocsMoveTree",{ "mid":current_mid,"parent_srl":parent_srl,"target_srl":target_srl,"source_srl":source_srl}, function(data){ Tree(); });
...
jQuery(document).ready(function() {
	if ( jQuery('#xeDocsBody').height() > jQuery('#xeDocsTree').height() ) {
