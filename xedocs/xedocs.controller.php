<?php
    ...
    class xedocsController extends xedocs {
        ...
        /**
         * @brief Action for adding or editing a new document
         */
        function procXedocsInsertDocument()
        {
                ...
                $this->_recompileTree($this->module_srl);
        ...
        /**
         *
         * @brief Action for deleting a document
         */
        ...
        /**
         * @brief Action for deleting a comment
         */
        ...
        /**
         * @brief Action adding / editing tree hierarchy
         */
        ...
        /**
         * @brief Action for rebuilding documents tree cache
         */
        function procXedocsRecompileTree()
        {
                ...
                return $this->_recompileTree($this->module_srl);
        }

        /**
         * @brief Helper method for rebuilding documents tree cache
         */
        function _recompileTree($module_srl)
        {
